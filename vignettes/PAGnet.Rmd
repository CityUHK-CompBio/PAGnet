...
abstract: PAGnet is an R package to perform Master Regulator Analysis (MRA) in Pseudomonas aeruginosa Genomic netork (PAGnet).
...
```{r}
  ...
  mra_results <- pagnet.mra(rnet=PAGnet,tflist=tf,signature = t3ss, 
